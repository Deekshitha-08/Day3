...
class LuggageLimitException extends Exception{
    ...
    {
        System.out.println(name+ +exceedWeight+" kg");
    }
...
public class Assgnque1 {
    public static void main(String[] args) {
        ...
        catch(Exception e)
        {
            ...
            System.out.println(passengerOne.name+""+(extraWeight*500)+" rs");
        }
        try
        {
        ...
        catch (Exception e)
        {
            ...
            System.out.println(passengerTwo.name+" "+(extraWeight*500)+" rs");
        }
